DELIMITER $$
DROP PROCEDURE IF EXISTS roverResultsNumGroupsUncat;
CREATE PROCEDURE roverResultsNumGroupsUncat(IN in_core_system text, out out_result int)
BEGIN
-- -----------------------------------------------------------------------------------------------------
-- (C) Red Hound Limited 2015
-- -----------------------------------------------------------------------------------------------------
--
-- Title	ROVER - Number of Groups that are Uncategorised
--
-- DB:		MARIADB
--
-- Purpose	Retrieve the number of Groups that are Uncategorised for systems that are switched on
--
...
-- Logging variables
-- -----------------------------------------------------
DECLARE v_logging_process TEXT DEFAULT 'roverResultsNumGroupsUncat';
