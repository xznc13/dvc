DELIMITER $$
DROP PROCEDURE IF EXISTS roverResultsNumGroups;
CREATE PROCEDURE roverResultsNumGroups(IN in_core_system text, out out_result int)
BEGIN
-- -----------------------------------------------------------------------------------------------------
-- (C) Red Hound Limited 2015
-- -----------------------------------------------------------------------------------------------------
--
-- Title	ROVER - Number of Groups
--
-- DB:		MARIADB
--
-- Purpose	Retrieve the number of Groups for systems that are switched on
--
...
-- Logging variables
-- -----------------------------------------------------
DECLARE v_logging_process TEXT DEFAULT 'roverResultsNumGroups';
