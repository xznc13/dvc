DELIMITER $$
DROP PROCEDURE IF EXISTS roverFilterRules;
CREATE PROCEDURE roverFilterRules()
BEGIN
-- -----------------------------------------------------------------------------------------------------
-- (C) Red Hound Limited 2015
-- -----------------------------------------------------------------------------------------------------
--
-- Title	ROVER - Filter Rules
--
-- DB:		MARIADB
--
-- Purpose	Retrieve the list of filter rules
--
...
-- Logging variables
-- -----------------------------------------------------
DECLARE v_logging_process TEXT DEFAULT 'roverFilterRules';
...
SET v_sql_command = concat(v_sql_command,'   FROM filter_rules ');
