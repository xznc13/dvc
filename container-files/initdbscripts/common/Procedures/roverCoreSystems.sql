DELIMITER $$
DROP PROCEDURE IF EXISTS roverCoreSystems;
CREATE PROCEDURE roverCoreSystems()
BEGIN
-- -----------------------------------------------------------------------------------------------------
-- (C) Red Hound Limited 2015
-- -----------------------------------------------------------------------------------------------------
--
-- Title	ROVER - Core Systems
--
-- DB:		MARIADB
--
-- Purpose	Retrieve the list of core systems
--
...
-- Logging variables
-- -----------------------------------------------------
DECLARE v_logging_process TEXT DEFAULT 'roverCoreSystems';
