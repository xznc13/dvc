DELIMITER $$
DROP PROCEDURE IF EXISTS roverResultsNumGroupsCat;
CREATE PROCEDURE roverResultsNumGroupsCat(IN in_core_system text, out out_result int)
BEGIN
-- -----------------------------------------------------------------------------------------------------
-- (C) Red Hound Limited 2015
-- -----------------------------------------------------------------------------------------------------
--
-- Title	ROVER - Number of Groups that are Categorised
--
-- DB:		MARIADB
--
-- Purpose	Retrieve the number of Groups that are Categorised for systems that are switched on
--
...
-- Logging variables
-- -----------------------------------------------------
DECLARE v_logging_process TEXT DEFAULT 'roverResultsNumGroupsCat';
