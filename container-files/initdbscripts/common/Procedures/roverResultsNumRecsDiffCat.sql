DELIMITER $$
DROP PROCEDURE IF EXISTS roverResultsNumRecsDiffCat;
CREATE PROCEDURE roverResultsNumRecsDiffCat(IN in_core_system text, out out_result int)
BEGIN
-- -----------------------------------------------------------------------------------------------------
-- (C) Red Hound Limited 2015
-- -----------------------------------------------------------------------------------------------------
--
-- Title	ROVER - Number of records with differences that are categorised
--
-- DB:		MARIADB
--
-- Purpose	Retrieve the number of records with differences that have been categorised for systems that are switched on
--
...
-- Logging variables
-- -----------------------------------------------------
DECLARE v_logging_process TEXT DEFAULT 'roverResultsNumRecsDiffCat';
