DELIMITER $$
DROP PROCEDURE IF EXISTS roverDuplicateCountsForProd;
CREATE PROCEDURE roverDuplicateCountsForProd(IN in_core_system text)
BEGIN
-- -----------------------------------------------------------------------------------------------------
-- (C) Red Hound Limited 2015
-- -----------------------------------------------------------------------------------------------------
--
-- Title	ROVER - Number of Duplicates in PROD
--
-- DB:		MARIADB
--
-- Purpose	Retrieve the number of Duplicates in PROD for systems that are switched on
--
...
-- Logging variables
-- -----------------------------------------------------
DECLARE v_logging_process TEXT DEFAULT 'roverDuplicateCountsForProd';
