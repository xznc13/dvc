DELIMITER $$
DROP PROCEDURE IF EXISTS roverResultsNumRecsNoDiff;
CREATE PROCEDURE roverResultsNumRecsNoDiff(IN in_core_system text, out out_result int)
BEGIN
-- -----------------------------------------------------------------------------------------------------
...
-- Logging variables
-- -----------------------------------------------------
DECLARE v_logging_process TEXT DEFAULT 'roverResultsNumRecsNoDiff';
